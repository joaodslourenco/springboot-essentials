...
class AnimeControllerIT {
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved("One Piece"));
    ...
    void save_ReturnsAnime_WhenSuccessful() {
        ...
        Assertions.assertThat(anime).isNotNull();
        Assertions.assertThat(anime.getBody()).isEqualTo(AnimeCreator.createValidAnime(1L, "One Piece"));
